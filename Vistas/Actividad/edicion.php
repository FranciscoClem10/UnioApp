...
if (!isset($actividades)) {
    $actividades = []; // Reemplaza con tu lógica real
}
...
<div class="flex-1 overflow-y-auto px-8 py-6 max-w-7xl mx-auto w-full">
    ...
    <!-- Mensajes de sesión (se mantienen igual) -->
    ...
    <div class="bg-surface-container-lowest rounded-xl shadow-[0_8px_32px_rgba(45,47,47,0.06)] overflow-hidden">
        <div class="px-6 py-6 bg-surface-container-low flex flex-col sm:flex-row sm:justify-between sm:items-center gap-4">
            ...
            <div class="flex gap-2">
                ...
                <!-- Botón de cambio de tema (ahora viene en header.php, pero puedes mantenerlo aquí si lo deseas) -->
            </div>
        </div>
...
<!-- Scripts de filtrado y modo oscuro (el toggle del tema ya está en header.php, pero mantenemos el filtro) -->
<script>
...
<?php
// Incluir el footer (cierra las etiquetas abiertas por header.php)
